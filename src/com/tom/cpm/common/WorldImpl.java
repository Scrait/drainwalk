...
public class WorldImpl implements World {
	...
	public static void setWorld(AnimationState a, Entity ent) {
		...
		a.dayTime = l.func_241851_ab();
		a.skyLight = l.getLightFor(LightType.SKY, i.base);
		a.blockLight = l.getLightFor(LightType.BLOCK, i.base);
	}
	...
	public int getMaxHeight() {
		return level.call(IBlockReader::getHeight, 0);
	}
	...
	public String getDimension() {
		return level.call(l -> l.getDimensionKey().getLocation().toString(), null);
	}
}
