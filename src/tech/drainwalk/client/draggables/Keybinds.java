...
public class Keybinds extends DraggableComponent {
    ...
    private final FloatOption offsetOption = new FloatOption("Offset", 15, 10, 20).addIncrementValue(0.1f);
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        try {
            ...
            keybindsAnimation.update(true);
        } catch (NoSuchElementException ignored) {
            keybindsAnimation.update(false);
        }
    }
    ...
    public void onRender2D(EventRender2D event) {
        ...
        keybindsAnimation.animate(0, 1, 0.15f, EasingList.BACK_OUT, mc.getTimer().renderPartialTicks);
...
//            matrixStack.scale(2, 2, 2);
            GLService.INSTANCE.scaleAnimation(matrixStack, x, y, widthAnim, getDraggableOption().getHeight(), keybindsAnimation.getAnimationValue());

            // background
            RenderService.drawRoundedLinearGradientRect(matrixStack, x, y, widthAnim, getDraggableOption().getHeight(), round, backgroundFirstColor, backgroundSecondColor);
            // title
            {
                // left
                ...
                SFPD_REGULAR.drawCenteredText(matrixStack,
                        ...
                        x + padding.getValue() + 20 + 8f, y + padding.getValue() + 1f, textSecondColor, FONT_SIZE);
