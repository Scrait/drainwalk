package tech.drainwalk.client.gui;
...
import tech.drainwalk.client.font.SFontRenderer;

public class TextField extends Widget implements IRenderable, IGuiEventListener
{
    private final SFontRenderer fontRenderer;
    ...
    public TextField(SFontRenderer p_i232260_1_, int p_i232260_2_, int p_i232260_3_, int p_i232260_4_, int p_i232260_5_, ITextComponent p_i232260_6_)
    {
        this(p_i232260_1_, p_i232260_2_, p_i232260_3_, p_i232260_4_, p_i232260_5_, (TextFieldWidget)null, p_i232260_6_);
    }

    public TextField(SFontRenderer p_i232259_1_, int p_i232259_2_, int p_i232259_3_, int p_i232259_4_, int p_i232259_5_, @Nullable TextFieldWidget p_i232259_6_, ITextComponent p_i232259_7_)
    {
    ...
    public void renderButton(MatrixStack matrixStack)
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = (int) this.fontRenderer.drawStringWithShadow(matrixStack, s1, (float)l, (float)i1, i2);
            }
            ...
            {
                this.fontRenderer.drawStringWithShadow(matrixStack, s.substring(j), (float)j1, (float)i1, i2);
            }
