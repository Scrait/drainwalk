...
public class Vector3d implements IPosition
{
    ...
    public float distanceTo(Entity entityIn)
    {
        float f = (float)(this.x - entityIn.getPosX());
        float f1 = (float)(this.y - entityIn.getPosY());
        float f2 = (float)(this.z - entityIn.getPosZ());
