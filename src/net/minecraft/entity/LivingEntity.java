...
public abstract class LivingEntity extends Entity
{
    ...
    protected void onDeathUpdate()
    {
        ...
        {
            this.remove();
            final EventEntityDeath eed = new EventEntityDeath();
            EventManager.register(eed);
    ...
    protected void jump()
    {
        ...
        if (this instanceof ClientPlayerEntity) {
            final JumpEvent event = new JumpEvent(f, this.rotationYaw);
            ...
            if (this.isSprinting())
            {
                float f1 = event.getYaw() * ((float)Math.PI / 180F);
    ...
    {
        final NoPushEvent npe = new NoPushEvent(NoPushEvent.PushType.Entities);
