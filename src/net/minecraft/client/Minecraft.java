            ...
            else if (!this.player.isRowingBoat())
            {
                switch (this.objectMouseOver.getType())
                {
                    case ENTITY:
                        ...
                        //ViaMCP
                        if (!(Drainwalk.getInstance().getApiMain().getModuleManager().findByClass(NoFriendDamage.class).isEnabled() && Drainwalk.getInstance().getApiMain().getFriendManager().existsByName(((EntityRayTraceResult)this.objectMouseOver).getEntity().getName().getString()))) {
