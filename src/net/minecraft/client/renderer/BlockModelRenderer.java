...
public class BlockModelRenderer
{
    ...
    public boolean renderModel(IBlockDisplayReader p_renderModel_1_, IBakedModel p_renderModel_2_, BlockState p_renderModel_3_, BlockPos p_renderModel_4_, MatrixStack p_renderModel_5_, IVertexBuilder p_renderModel_6_, boolean p_renderModel_7_, Random p_renderModel_8_, long p_renderModel_9_, int p_renderModel_11_)
    {
        ...
        try
        {
            ...
            boolean flag1 = flag ? this.renderModelSmooth(p_renderModel_1_, p_renderModel_2_, p_renderModel_3_, p_renderModel_4_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_8_, p_renderModel_9_, p_renderModel_11_) : this.renderModelFlat(p_renderModel_1_, p_renderModel_2_, p_renderModel_3_, p_renderModel_4_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_8_, p_renderModel_9_, p_renderModel_11_);
    ...
    public boolean renderModelSmooth(IBlockDisplayReader p_renderModelSmooth_1_, IBakedModel p_renderModelSmooth_2_, BlockState p_renderModelSmooth_3_, BlockPos p_renderModelSmooth_4_, MatrixStack p_renderModelSmooth_5_, IVertexBuilder p_renderModelSmooth_6_, boolean p_renderModelSmooth_7_, Random p_renderModelSmooth_8_, long p_renderModelSmooth_9_, int p_renderModelSmooth_11_)
    {
        ...
        for (Direction direction : Direction.VALUES)
        {
            if (!p_renderModelSmooth_7_ || BlockUtils.shouldSideBeRendered(p_renderModelSmooth_3_, p_renderModelSmooth_1_, p_renderModelSmooth_4_, direction, renderenv))
            {
                ...
                List<BakedQuad> list = p_renderModelSmooth_2_.getQuads(p_renderModelSmooth_3_, direction, p_renderModelSmooth_8_);
        ...
        p_renderModelSmooth_8_.setSeed(p_renderModelSmooth_9_);
        List<BakedQuad> list1 = p_renderModelSmooth_2_.getQuads(p_renderModelSmooth_3_, (Direction)null, p_renderModelSmooth_8_);
    ...
    public boolean renderModelFlat(IBlockDisplayReader p_renderModelFlat_1_, IBakedModel p_renderModelFlat_2_, BlockState p_renderModelFlat_3_, BlockPos p_renderModelFlat_4_, MatrixStack p_renderModelFlat_5_, IVertexBuilder p_renderModelFlat_6_, boolean p_renderModelFlat_7_, Random p_renderModelFlat_8_, long p_renderModelFlat_9_, int p_renderModelFlat_11_)
    {
        boolean flag = false;
        ...
        for (Direction direction : Direction.VALUES)
        {
            if (!p_renderModelFlat_7_ || BlockUtils.shouldSideBeRendered(p_renderModelFlat_3_, p_renderModelFlat_1_, p_renderModelFlat_4_, direction, renderenv))
            {
                ...
                List<BakedQuad> list = p_renderModelFlat_2_.getQuads(p_renderModelFlat_3_, direction, p_renderModelFlat_8_);
        ...
        p_renderModelFlat_8_.setSeed(p_renderModelFlat_9_);
        List<BakedQuad> list1 = p_renderModelFlat_2_.getQuads(p_renderModelFlat_3_, (Direction)null, p_renderModelFlat_8_);
    ...
    {
        this.renderModel(matrixEntry, buffer, state, modelIn, red, green, blue, combinedLightIn, combinedOverlayIn);
    }

    public void renderModel(MatrixStack.Entry p_renderModel_1_, IVertexBuilder p_renderModel_2_, @Nullable BlockState p_renderModel_3_, IBakedModel p_renderModel_4_, float p_renderModel_5_, float p_renderModel_6_, float p_renderModel_7_, int p_renderModel_8_, int p_renderModel_9_)
    {
