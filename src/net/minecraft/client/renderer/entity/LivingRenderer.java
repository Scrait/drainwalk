...
public abstract class LivingRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements IEntityRenderer<T, M>, LivingRendererAccess
{
    ...
    public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        float f7 = entityIn == Minecraft.getInstance().getRenderViewEntity() ? MathHelper.lerp(partialTicks, entityIn.prevRotationPitchHead, entityIn.rotationPitchHead) : MathHelper.lerp(partialTicks, entityIn.prevRotationPitch, entityIn.rotationPitch);
