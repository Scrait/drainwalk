...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public void renderBlockDamage(BlockState p_renderBlockDamage_1_, BlockPos p_renderBlockDamage_2_, IBlockDisplayReader p_renderBlockDamage_3_, MatrixStack p_renderBlockDamage_4_, IVertexBuilder p_renderBlockDamage_5_)
    {
        if (p_renderBlockDamage_1_.getRenderType() == BlockRenderType.MODEL)
        {
            ...
            this.blockModelRenderer.renderModel(p_renderBlockDamage_3_, ibakedmodel, p_renderBlockDamage_1_, p_renderBlockDamage_2_, p_renderBlockDamage_4_, p_renderBlockDamage_5_, true, this.random, i, OverlayTexture.NO_OVERLAY);
        }
    }

    public boolean renderModel(BlockState p_renderModel_1_, BlockPos p_renderModel_2_, IBlockDisplayReader p_renderModel_3_, MatrixStack p_renderModel_4_, IVertexBuilder p_renderModel_5_, boolean p_renderModel_6_, Random p_renderModel_7_)
    {
        try
        {
    ...
    public void renderBlock(BlockState p_renderBlock_1_, MatrixStack p_renderBlock_2_, IRenderTypeBuffer p_renderBlock_3_, int p_renderBlock_4_, int p_renderBlock_5_)
    {
        ...
        if (blockrendertype != BlockRenderType.INVISIBLE)
        {
            switch (blockrendertype)
            {
                case MODEL:
                    ...
                    this.blockModelRenderer.renderModel(p_renderBlock_2_.getLast(), p_renderBlock_3_.getBuffer(RenderTypeLookup.func_239220_a_(p_renderBlock_1_, false)), p_renderBlock_1_, ibakedmodel, f, f1, f2, p_renderBlock_4_, p_renderBlock_5_);
                    break;
