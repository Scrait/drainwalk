...
public final class MainWindow implements AutoCloseable
{
    ...
    public int getScaledWidthWithoutAutisticMojangIssue(int factor)
    {
        return (int) (this.scaledWidth * getGuiScaleFactor() / factor);
    }
    ...
    public int getScaledHeightWithoutAutisticMojangIssue(int factor)
    {
        return (int) (this.scaledHeight * getGuiScaleFactor() / factor);
    }
