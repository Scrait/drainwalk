...
public class InputMappings
{
    ...
    public static InputMappings.Input getInputByNamePatched(String name)
    {
       return getInputByName("key.keyboard." + name);
    }
    ...
    public static final class Input
    {
        ...
        public String getTranslationKeySplit()
        {
            return this.name.substring(13);
        }
