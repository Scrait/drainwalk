...
public class InventoryScreen extends DisplayEffectsScreen<PlayerContainer> implements IRecipeShownListener
{
    ...
    protected void init()
    {
        ...
        else
        {
            ...
            this.addButton(new Button(this.guiLeft + 54, this.height / 2 - 106, 60, 20, ITextComponent.getTextComponentOrEmpty("Drop Items"), (button) -> {
                for (int k = 0; k < 46; ++k) {
                    if (this.minecraft.player.openContainer.getSlot(k).getHasStack()) {
                        this.minecraft.playerController.windowClick(this.minecraft.player.openContainer.windowId, k, 1, ClickType.THROW, this.minecraft.player);
                    }
                }
            }));
        }
