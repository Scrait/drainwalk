...
public class MainMenuScreen extends Screen
{
    ...
    private void addSingleplayerMultiplayerButtons(int yIn, int rowHeightIn)
    {
        ...
        (this.addButton(new Button(this.width / 2 - 100, yIn + rowHeightIn * 2, 200, 20, new TranslationTextComponent("Alt Manager"), (p_lambda$addSingleplayerMultiplayerButtons$7_1_) ->
        {
            minecraft.displayGuiScreen(new AltGui());
        }, button$itooltip))).active = flag;
    }
